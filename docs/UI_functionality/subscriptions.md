...
- **Observatory** — статус живости из реальной проверки Xray (не просто
  ...
  проверено. Подробный разбор механики — [docs/balancer.md](../balancer.md).
...
- **Предупреждение рядом** — если состав подписки поменяется, теги
  ...
  пометкой в профиле). Полный механизм — [docs/subscription-update.md](../subscription-update.md).
...
это работает при обычном обновлении — см. [docs/subscription-update.md](../subscription-update.md)).
