...
- **Режим**:
  ...
  - **Группа (авто-выбор)** — балансировщик сам выбирает самый быстрый
    ...
    минуты) — подробности и почему не встроенный `leastPing` Xray — [docs/balancer.md](../balancer.md).
...
при следующем сохранении профиля через UI. Полный механизм — [docs/subscription-update.md](../subscription-update.md).
