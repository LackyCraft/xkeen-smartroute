# Функциональность интерфейса, по вкладкам

Полное описание каждой вкладки LuCI-модуля — что на ней есть, как
пользоваться, и нефункциональные нюансы (что означают конкретные
индикаторы, почему что-то выглядит непривычно, но так и задумано).
